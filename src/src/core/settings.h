...
struct Settings
{
  ...
  CPUExecutionMode cpu_execution_mode = CPUExecutionMode::CachedInterpreter;
  ...
  bool cpu_recompiler_memory_exceptions = true;
  ...
  bool sensors_enable = false;
  bool sensors_up = false;
  bool sensors_down = false;
  float sensors_sens = 1.5f;

  bool touch_force = false;
  bool native_event = false;
  bool native_ui = true;
  bool gaming_ui = true;
  bool gaming_event = false;
  bool gaming_quick = true;
  bool touch_analog = false;
  bool touch_log = false;
  bool gaming_map = false;
  u32 gaming_custom_cross = 0;
  u32 gaming_custom_circle = 1;
  u32 gaming_custom_square = 2;
  u32 gaming_custom_train = 3;
  u32 gaming_custom_r1 = 4;
  u32 gaming_custom_l1 = 5;
  u32 gaming_custom_up = 6;
  u32 gaming_custom_down = 7;
  u32 gaming_custom_left = 8;
  u32 gaming_custom_right = 9;
  u32 gaming_custom_l2 = 10;
  u32 gaming_custom_r2 = 11;
  u32 gaming_custom_l3 = 12;
  u32 gaming_custom_r3 = 13;
  u32 gaming_custom_start = 14;
  u32 gaming_custom_select = 15;
...
#endif
  bool touch_hide_dpad = false;
  bool touch_show_lr3 = false;
  bool touch_action_extra = true;
  bool touch_dpad_extra = true;
  bool d3d93_compatibility = false;
  u32 shader_compatibility = 0;
  u32 shader_opt = 0;
  bool d3dnotice = true;
  ...
  bool display_linear_filtering = false;
  ...
  s32 touch_opacity = 30;
  s32 touch_port = 1;
  s32 native_port = 1;
  s32 buffer_count = 3;
  s32 max_frames_to_run = 2;
  float touch_scale = 1.0f;
  float touch_scalep = 1.0f;
  float touch_analog_s = 1.0f;
  float touch_analog_sc = 1.5f;
  float touch_sens = 8.0f;
  ...
  // safe_memory usually set to false for WindowsPhone unlocked + root access devices (since they can use Win32 as sandbox is no more)
  // Otherwise keep it true, there is no way to get that work on UWP, WindowsPhone has exception
  bool safe_memory = true;
  bool cache_shader = true;
