...
#else
static constexpr float LAYOUT_SCREEN_WIDTH = 1920.0f;
static constexpr float LAYOUT_SCREEN_HEIGHT = 1080.0f;
#endif
...
static ALWAYS_INLINE float LayoutScale(float v, bool ignore = false)
{
  /*if (isLevel93 && !ignore)
  {
    return (g_layout_scale * v) * 0.95;
  }
  else*/
  {
